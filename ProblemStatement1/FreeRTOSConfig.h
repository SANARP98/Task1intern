...
#define configUSE_PORT_OPTIMISED_TASK_SELECTION 0 /* Avoid 32-bit shifts on 8-bit type in template port */

/* Platform-specific settings */
#define configCPU_CLOCK_HZ                  ((unsigned long)100000000)  /* 100 MHz */
#define configTICK_RATE_HZ                  ((TickType_t)1000)          /* 1ms tick */
#define configTICK_TYPE_WIDTH_IN_BITS       TICK_TYPE_WIDTH_32_BITS     /* Use 32-bit tick type for POSIX port */
#define configMAX_PRIORITIES                (5)                         /* 0-4 valid */
#define configMINIMAL_STACK_SIZE            ((unsigned short)128)       /* Min stack */
#define configTOTAL_HEAP_SIZE               ((size_t)(96 * 1024))       /* 96KB heap ensures POSIX port tasks + idle */
